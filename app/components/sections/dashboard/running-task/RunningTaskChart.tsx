...
import ReactEcharts from '../../../base/ReactEchart';
...
const RunningTaskChart = ({ data, ...rest }: RunningTaskChartProps) => {
      ...
      series: [
        {
          ...
          axisLine: {
            lineStyle: {
              width: 3,
              color: [[1, theme.palette.grey[800]]], // Using grey as a fallback
            },
          },
          splitLine: {
            show: false,
  ...
  return <ReactEcharts echarts={echarts} option={option} {...rest} />;
};
